      ...
      <div>
        ...
        <div className="flex flex-col justify-start mt-4 ml-10">
          ...
          <div className="flex flex-row justify-evenly mt-4 space-x-32">
            <div className="flex flex-row items-center">
              {postLikedByLoggedUser(loginUser, post) ? (
                ...
                <FiHeart
                  ...
                  className="mr-1 w-5 h-5 text-emerald-400 hover:text-red-500 cursor-pointer"
                />
              )}
            ...
            <div className="flex flex-row items-center">
              <FaComment className="mr-1 w-5 h-5 text-emerald-400 hover:text-emerald-500 cursor-pointer" />
            ...
            <div className="flex flex-row items-center">
              {postAlreadyBookmarked(_id) ? (
                <BiSolidBookmark
                  ...
                  className="mr-1 w-5 h-5 text-emerald-400 hover:text-amber-400 cursor-pointer"
                />
              ) : (
                <BsBookmark
