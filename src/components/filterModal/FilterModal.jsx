...
import { MdCancel, FaArrowDown, FaArrowUp, FaFire } from "../../utils/icons";
  ...
  return (
    <div>
      <div className="text-sm flex flex-col gap-0.5 items-start py-1 px-1 shadow-lg border rounded border-gray-300 bg-slate-50">
        ...
        <button
          style={{
            backgroundColor: filter === "trending" ? "#33333" : "#fffff",
        ...
        <button
          style={{
            backgroundColor: filter === "latest" ? "#33333" : "#fffff",
        ...
        <button
          style={{
            backgroundColor: filter === "oldest" ? "#33333" : "#fffff",
