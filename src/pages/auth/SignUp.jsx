    ...
    <div className="flex justify-center items-center h-screen bg-emerald-100">
      <form className="w-80 bg-white shadow-md rounded px-8 py-6">
        <div className="mb-4">
          ...
          <input
            className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              alertMessage.fnameError ? "border-red-500" : ""
            }`}
            type="text"
            placeholder="Adarsh"
            required={true}
        ...
        <div className="mb-4">
          ...
          <input
            className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              alertMessage.lnameError ? "border-red-500" : ""
            }`}
            type="text"
            placeholder="Balika"
            required={true}
        ...
        <div className="mb-4">
          ...
          <input
            className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              alertMessage.usernameError ? "border-red-500" : ""
            }`}
            type="text"
        ...
        <div className="mb-4">
          ...
          <input
            className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              alertMessage.passwordError ? "border-red-500" : ""
            }`}
            type="password"
            required={true}
        ...
        <div className="mb-4">
          ...
          <input
            className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              alertMessage.confirmPasswordError ? "border-red-500" : ""
            }`}
            type="password"
            required={true}
        ...
        <div className="mt-4">
          ...
          <Link
            className="text-emerald-300 hover:text-emerald-500 font-bold"
            to="/login"
          >
            Sign In
          </Link>
