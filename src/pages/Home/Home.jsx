...
export default function Home() {
  ...
  const {
    postState: { allPosts, filterType },
  } = usePost();
  const postsOfFollowers = allPosts?.filter(
    (post) =>
      loginUser?.following.some(
    ...
    <div className="flex justify-center">
      ...
      <div className="w-2/4 border border-gray-700 md:align-middle">
        <div className="flex flex-row justify-between border-b-2 border-gray-500 pb-2">
          <h2 className="font-bold text-lg text-gray-600 text-center m-3">
            Home
          </h2>
